 ...
 * org.recommender101.Recommender101.java
 */
package daql;
...
public class ProgrammingTask5 {
     ...
     * @param confFileName
     */
    public ProgrammingTask5(Properties configuration) throws Exception {
     ...
     * and inits things
     */
    public ProgrammingTask5() throws Exception {
     ...
     */
    public List<EvaluationResult> calculateAverageResults(
            Map<Integer, List<EvaluationResult>> resultsPerEvalRun)
            throws Exception {
    ...
    public void printSortedEvaluationResults(List<EvaluationResult> results) {
        ...
        System.out.println("Overall time in seconds: "
                + (impl.runner.computationTime / (double) 1000));
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Recommender101 called with parameters: "
                    + Utilities101.printArray(args));

            Properties props = null;
            String propertyFile = "conf/recommender101.properties";
            ...
            try {
                ...
                e.printStackTrace();
                System.out
                        .println("USAGE: org.recommender101.Recommender101 [propertyFileName] [--noMovieLensDownload]");
                System.exit(1);
            }
            ...
            if (downloadML) {
                System.out
                        .println("Checking if test data has to be downloaded..");
            ...
            if (props == null) {
                System.out
                        .println("Starting evaluation with default configuration file");
    ...
    public static boolean cmdLineArgumentExists(String[] args, String thearg) {
        ...
        for (String arg : args) {
            if (arg.startsWith("--") && arg.length() > 2) {
                if (((String) arg.subSequence(2, arg.length()))
                        .equalsIgnoreCase(thearg)) {
                    return true;
                }
            }
        }
