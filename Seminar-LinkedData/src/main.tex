...
Bühmann et al \cite{paper2} uses many different types to enrich the knowledge
base.
...
Preliminary Evaluation has also been done in the paper by Bühmann et al for OWL
 axiom enrichment. The authors choose DBpedia to test their algorithms. Table
3 shows a small subset of the results.
In Bühmann et al\cite{paper2} the evaluation is discussed in great detail. For
...
\caption{Evaluation results of Bühmann et al \cite{paper2} (combined object and
