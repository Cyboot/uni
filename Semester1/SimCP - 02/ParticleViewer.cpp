...
const DclFloat  WORLD_RED = 0.1;
const DclFloat  WORLD_GREEN = 0.1;
const DclFloat  WORLD_BLUE = 0.3;

const DclFloat LIGHT_X = 1.0;
const DclFloat LIGHT_Y = 5.0;
...
void  visualizeParticles()
{
  ...
  particleFaces->coordIndex.deleteValues(0);
...
int main(int argc, char ** argv )
{
  ...
  root->addChild(pointlight(SbVec3f(-5, -5, 0), SbVec3f(1.0, 1.0, 1.0)));
